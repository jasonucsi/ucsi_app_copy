...
const LoginOTP = ({navigation, route}) => {
  ...
  const handleLogin = async values => {
    try {
      ...
      const deviceUUID = await RNSecureStorage.get('deviceUUID');
      ...
      <View style={{marginBottom: 40}}>
        <View style={{marginBottom: 24, marginHorizontal: 24}}>
          ...
          <View style={{marginBottom: 16}}>
            ...
            <Text style={{color: '#bcbbc1'}}>
              {I18n.t('LoginPage.Label.requestOtpAgain')}
            </Text>
          </View>
          <View
            style={{
            ...
            <Text style={{fontSize: 16}}>
              {route.params && route.params.data.phone}
            </Text>
          </View>
        </View>
